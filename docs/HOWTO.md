...
You can access the documentation here with [How to use the library](https://github.com/mvac7/SDCC_interruptM1/blob/master/HOWTO.md).
...
### 5.1 If you use an Interrupt Service Routine (ISR)

The MSX system uses an ISR that manages DOS and BASIC functionalities.
